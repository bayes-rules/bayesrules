...
[![R-CMD-check](https://github.com/bayes-rules/bayesrules/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/bayes-rules/bayesrules/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
