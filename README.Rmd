...
**bayesrules** is a package to supplement the Bayes Rules! book. It contains datasets and functions that are used in the book. Currently it is under development.
