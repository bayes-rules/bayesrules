#' Pizza Ratings Data
#' 
#' Wrangled data on pizza ratings originally collected by the "One Bite" app and distributed through the R for Data Science TidyTuesday project.
...
#'   \item{app_rating}{rating given by the app managers}
#' }
#' @source 
