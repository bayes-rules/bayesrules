...
#' \describe{
#'   \item{subject}{a unique identifier for the runner}
...
#'   }
#' @source Data in the original Cherry data set were obtained from \url{http://www.cherryblossom.org/aboutus/results_list.php}.
